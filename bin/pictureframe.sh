...
USER="mdauso"                                               # FTPS user
PASSWORT="Hecke2009-Paula-Mucki2013"                        # FTPS password
PORT="22"                                                   # port of FTPS-Server
FTPADRESSE="ksrj33hyzvoidzke.myfritz.net"                   # DynDNS adress of FTPS server

#Where will the picture frame be located
#HOSTNAME="Marksuhl"
HOSTNAME="Oberboesa"
#HOSTNAME="Eddigehausen"
